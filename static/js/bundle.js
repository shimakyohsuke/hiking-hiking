...
var _flipsnapMin = __webpack_require__(1);

var _flipsnapMin2 = _interopRequireDefault(_flipsnapMin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery2.default)(function () {
  var wrapWidth = (0, _jquery2.default)('.hh-flipsnap').width();
  var listCount = (0, _jquery2.default)('.hh-flipsnap__item').length;
  console.log(wrapWidth);
  console.log(listCount);
  window.addEventListener('load', function (eve) {
    (0, _jquery2.default)('.hh-flipsnap__item').css({ 'width': wrapWidth });
    (0, _jquery2.default)('.hh-flipsnap__inner').css({ 'width': wrapWidth * listCount });
  });
  var $pointer = (0, _jquery2.default)('.pointer span');
  var flipsnap = (0, _flipsnapMin2.default)('.flipsnap', {
    distance: wrapWidth
  });
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(root,factory){if(true){!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
